...
// === ЛОГІКА "ІНТЕРКОМУ" (ВИПРАВЛЕНО v15.1) ===
...
function receiveMessage(event) {
  ...
  // "Охоронець" перевіряє, що "голос" (event.origin) 
  // збігається з вашим сайтом (ALLOWED_ORIGIN)
  
  // 🔴 === ОСЬ ВИПРАВЛЕННЯ ===
  // (Було 'ALLOWED_OCTYPE_ORIGIN', стало 'ALLOWED_ORIGIN')
